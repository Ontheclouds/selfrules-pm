...
.dummyfile{ display: none !important;}';
  ...
  <body>
            ...
            <div class="agent-info ">
              <div class="agent-pic shadow"><img src="
               <?php 
                ...
                " /></div>
              <div class="username">
                <a href="<?=site_url("agent");?>" class="user" data-toggle="modal"><?php echo character_limiter($this->user->firstname." ".$this->user->lastname, 19);?></a> 
      ...
      <hr>      
      <footer>
        <p><?=$core_settings->company;?></small></p>
      </footer>
      </div><!--/span-->
      </div><!--/row-->
